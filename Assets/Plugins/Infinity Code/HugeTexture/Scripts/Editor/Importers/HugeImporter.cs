...
{
    public abstract class HugeImporter : ScriptedImporter, IActiveBuildTargetChanged
    {
        ...
        public static TextureFormat GetTextureFormat(BuildTarget buildTarget, bool compressed, bool transparent)
        {
            ...
            if (compressed)
            {
                ...
                {
                    format = transparent ? TextureFormat.ASTC_RGBA_4x4 : TextureFormat.ASTC_RGB_4x4;
                }
                else
                {
